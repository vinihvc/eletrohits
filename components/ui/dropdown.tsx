...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <RPrimitive.Portal>
    <RPrimitive.Content
      ...
      className={cn(
        'z-50 min-w-[8rem] overflow-hidden rounded-lg border bg-popover/80 p-1 text-popover-foreground shadow-md backdrop-blur-xs',
...
>(({ className, inset, ...props }, ref) => (
  <RPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex cursor-default select-none items-center rounded-sm p-2 text-sm outline-hidden transition-colors focus:bg-accent focus:text-accent-foreground data-disabled:pointer-events-none data-disabled:opacity-50',
      inset && 'pl-8',
      className,
    )}
    {...props}
